...
$(function() {
        var bookmark = {
            data: [{
                name: '切导航版',
                link: 'https://boyhh.gitee.io/more',
                box_shadow: '#F18033',
...
var time = d.getHours();
if (time < 24) {
    document.getElementById("title").innerHTML = "hhh.ma网址导航| Good evening";
}
if (time < 18) {
    document.getElementById("title").innerHTML = "hhh.ma网址导航 | Good afternoon";
}
if (time < 12) {
    document.getElementById("title").innerHTML = "hhh.ma网址导航 | Good morning";
}
if (time < 5) {
    document.getElementById("title").innerHTML = "hhh.ma网址导航| 别熬夜了";
}
//title问候语结束
